...
public:
   ...
   * Added by AH:
   *
   * Gets the maximum STA long retry count (SLRC).
   *
...
private:
   ...
   *
   */
  void DoSetMaxSsrc (uint32_t ssrc);
  /**
   * Added by AH:
   *
   */
  uint32_t DoGetMaxSsrc (void) const;

  /**
   * Added by AH:
   */
  void DoSetMaxSlrc (uint32_t slrc);
  /**
   * Added by AH:
   */
  uint32_t DoGetMaxSlrc (void) const;

  /**
   * Added by AH:
   */
  void DoSetRtsCtsThreshold (uint32_t threshold);
  /**
   * Added by AH:
   */
  uint32_t DoGetRtsCtsThreshold (void) const;
