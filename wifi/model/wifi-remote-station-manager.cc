  ...
  static TypeId tid = TypeId ("ns3::WifiRemoteStationManager")
    ...
    .AddAttribute ("MaxSsrc",
                   ...
                   MakeUintegerAccessor (&WifiRemoteStationManager::SetMaxSsrc,
                                         &WifiRemoteStationManager::DoGetMaxSsrc),
    ...
    .AddAttribute ("MaxSlrc",
                   ...
                   MakeUintegerAccessor (&WifiRemoteStationManager::SetMaxSlrc,
                                         &WifiRemoteStationManager::DoGetMaxSlrc),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("RtsCtsThreshold",
                   ...
                   MakeUintegerAccessor (&WifiRemoteStationManager::SetRtsCtsThreshold,
                                         &WifiRemoteStationManager::DoGetRtsCtsThreshold),
                   MakeUintegerChecker<uint32_t> ())
...
// Added by AH:
uint32_t
WifiRemoteStationManager::DoGetMaxSsrc(void) const
{
  return m_maxSsrc;
}
...
// Added by AH:
uint32_t
WifiRemoteStationManager::DoGetMaxSlrc(void) const
{
  return m_maxSlrc;
}
...
// Added by AH:
uint32_t
WifiRemoteStationManager::DoGetRtsCtsThreshold(void) const
{
